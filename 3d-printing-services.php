...
<meta name="description" content="Get fast, highly precise metal & plastic parts with our 3D printing services using SLM280 & SLM500 printers for design support, prototyping, testing & production.">
...
<meta property="og:description" content="Get fast, highly precise metal & plastic parts with our 3D printing services using SLM280 & SLM500 printers for design support, prototyping, testing & production." />
<meta property="og:image" content="https://imacengineering.com/assets/main-service-page/Additive-Manufacturing-Services.webp" />
   ...
   <div class="service-content-banner">
      ...
      <header class="banner-header">
         ...
         <p class="banner-description">
          Have a part/assembly to design with complex shapes and internal features? Most manufacturing methods cannot work with 
          these details. We use additive manufacturing to build layer by layer - creating the exact geometries, sections, and custom
   ...
   <div class="imac-services-container">
      ...
      <div class="services-grid">
         ...
         <article class="service-card-drafting main-service">
            <div class="service-icon service-icon-1"><img src="./assets/Additive Manufacturing/Alpha Beta Validation AM Model.svg" alt=""></div>
         ...
         <article class="service-card-drafting">
            <div class="service-icon service-icon-2"><img src="./assets/Additive Manufacturing/Miniature Exhibition Model.svg" alt=""></div>
            ...
            <p class="service-description">We design compact, high-detail miniature models for exhibitions using the latest additive
                manufacturing tools. We create the same with updated design software and with the help of our skilled technicians, 
                these models offer an engaging way to present complex concepts at expos, meetings, or pitches.
</p>
         </article>
         <article class="service-card-drafting">
            <div class="service-icon service-icon-3"><img src="./assets/Additive Manufacturing/Scaled Working Model.svg" alt=""></div>
...
<section class="features-section">
   <div class="container">
      ...
      <div class="features-container">
         ...
         <div class="feature-box">
            <div class="feature-front">
               <img src="./assets/Orange Icons/Additive Manufacturing/Certified-Quality-Standards.svg" alt="Innovation Expertise"/>
         ...
         <div class="feature-box">
            <div class="feature-front">
               <img src="./assets/Orange Icons/Additive Manufacturing/Advanced-Technology&Materials.svg" alt="Advanced Technology & Materials"/>
         ...
         <div class="feature-box">
            <div class="feature-front">
               <img src="./assets/Orange Icons/Additive Manufacturing/Skilled-Team-and-Personal-Approach.svg" alt="Skilled Team and Personal Approach"/>
        ...
        <div class="feature-box">
            <div class="feature-front">
               <img src="./assets/Orange Icons/Additive Manufacturing/Innovation-That-Makes-a-Difference.svg" alt="Innovation That Makes a Difference"/>
