...
if ($_SERVER['REQUEST_METHOD'] === 'POST') {
    ...
    if (empty($captchaResult['success']) || $score < 0.5 || ($recaptchaAction && $action !== $recaptchaAction)) {
        error_log('reCAPTCHA failed (popup brochure): ' . $verifyResponse);
        echo 'error';
        exit;
    }

    if ($fullName && $email && $contactNumber) {
        // === Addresses / Subject (BROCHURE) ===
        $to           = "business@imacengineering.com";
        $subject      = "Brochure requested from website : www.imacengineering.com";

        // Keep these aligned with your working mail setup
        ...
        // Optional CC
        $cc = "info@hbsoftweb.com"; // set "" to disable
        ...
        <body>
            <div class="email-container">
                <div class="email-header">
                    <h2>Brochure requested from website : www.imacengineering.com</h2>
                </div>
